...
# python train_model.py --modelname FCN32s --num_workers 8  
def parse_config():
    ...
    # CNN architecture
    parser.add_argument("--arch", type=str, default="FCN32s", help='options: FCN32s, fcn_resnet101')
    ...
    parser.add_argument("--testset", type=str, default="/home/x227guo/workspace/SYDE675/Pixel_to_pixel/dataset/test/")
...
class Trainer(object):
    ...
    def _train_single_epoch(self, epoch):
        ...
        for step, sample_batched in enumerate(self.train_loader, 0):
            images_batch, grad_batch = sample_batched['dis'], sample_batched['grad']
